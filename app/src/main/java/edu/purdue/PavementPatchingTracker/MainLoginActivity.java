...
public class MainLoginActivity extends ActionBarActivity {
    ...
    static final String CURRENT_LOGIN_TYPE = "P";
//	static final String CURRENT_LOGIN_TYPE = "currentLoginType";
    ...
    static final int COLOR_ACTIVITY_PPTRACKER = COLOR_ACTIVITY_COMBINE;
	...
	public void autoFillVehicleInfo() {
        ...
        loginType = "P";
        EditText editText = (EditText) findViewById(R.id.editTextLoginVehicleId);
        changeBackgroudColor(editText, loginType);
...
//	}
	...
	private void changeBackgroudColor(View view, String loginType) {
		View root = view.getRootView();

        root.setBackgroundColor(getResources().getColor(
                COLOR_ACTIVITY_PPTRACKER));
...
//			return;
		...
		if (registeredType != null) {
			...
			if (!registeredType.equals(loginType)) {
                ...
                if(registeredType.equals("P")){
                    stringRegisteredType = getString(R.string.vehicle_pptracker);
                }else
